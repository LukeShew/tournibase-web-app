  ...
  return (
    <form action={action} className="mt-8 space-y-6">
      ...
      <section className="rounded-2xl border border-border bg-card p-5 sm:p-6">
        ...
        <div className="mt-6 grid gap-5 sm:grid-cols-2">
          ...
          <FormField id="publicSlug" label="Public event link">
            <div className="mt-2 flex h-12 overflow-hidden rounded-xl border border-border bg-black/20">
              ...
              <input
                ...
                readOnly
                disabled
                className="min-w-0 flex-1 bg-transparent px-3 font-mono text-sm text-slate-400 focus:outline-none"
              />
            </div>
      ...
      <section className="rounded-2xl border border-border bg-card p-5 sm:p-6">
        ...
        <p className="mt-4 rounded-xl border border-amber-300/20 bg-amber-300/[0.06] p-3 text-sm leading-6 text-amber-100">
      ...
      >
        <div>
          <p className="font-medium text-white">Save event details</p>
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <Link
            ...
            className="inline-flex h-12 shrink-0 items-center justify-center rounded-xl border border-border bg-white/[0.04] px-5 text-sm font-semibold text-slate-200 transition hover:border-white/20 hover:text-white"
          >
            Cancel
          </Link>
          <button
