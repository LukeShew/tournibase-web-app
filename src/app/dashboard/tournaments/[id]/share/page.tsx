...
import { EditableCoachMessage } from "@/components/editable-coach-message";
...
export default async function TournamentSharePage({
  ...
  return (
    <div className="pb-12">
      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-[1.25fr_0.75fr]">
        <section className="rounded-[2rem] border border-border bg-card shadow-sm">
          <div className="border-b border-border px-5 py-4">
            <h2 className="font-semibold text-slate-950">Coach share link</h2>
          ...
          <div className="p-5">
            <div className="rounded-2xl border border-border bg-white p-4">
              <p className="break-all font-mono text-sm leading-6 text-blue-700">
                {coachShareUrl}
              </p>
            </div>
      ...
      <section className="mt-6 rounded-[2rem] border border-border bg-card shadow-sm">
        <div className="border-b border-border px-5 py-4">
          <h2 className="font-semibold text-slate-950">Coach message</h2>
          <p className="mt-1 text-sm text-slate-500">
            Edit this before copying if a coach needs different wording.
          </p>
        </div>
        <div className="p-5">
          <EditableCoachMessage initialMessage={parentMessage} />
        </div>
      </section>

      <section className="mt-6 rounded-[2rem] border border-border bg-card p-5 shadow-sm">
